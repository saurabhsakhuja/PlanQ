...
import 'package:plan_q/src/modules/auth/presentation/screens/widgets/scrollable_age_widget.dart';
      ...
      child: Column(
        children: [
          Container(
            ...
            decoration: BoxDecoration(
                gradient: LinearGradient(
                    ...
                    colors: [
                      ...
                      Color(0xff121624).withOpacity(.4),
                      Color(0xff121624).withOpacity(.8),
                    ]),
            ...
            child: Container(
              decoration: BoxDecoration(color: Colors.white.withOpacity(.007)),
              child: Container(
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(20),
                  gradient: LinearGradient(
        ...
        child: Container(
          decoration: isSelected
              ? BoxDecoration(
                  ...
                  gradient: LinearGradient(
                    ...
                    colors: [
                      const Color(0xfffb65fb).withOpacity(.7),
                      Color(0xff3A246A),
                      Color(0xff3A246A),
                      Color(0xff3A246A).withOpacity(.3),
                    ],
                  ),
                )
              : null,
          child: Container(
            decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(9),
                color:
                    isSelected ? Colors.white.withOpacity(.08) : Colors.black),
            child: Container(
              ...
              child: Container(
                decoration: BoxDecoration(
                  color:
                      isSelected ? Colors.white.withOpacity(.02) : Colors.black,
                  borderRadius: BorderRadius.circular(9),
                ),
                child: Center(
                  child: Text(
